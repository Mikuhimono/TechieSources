...
function fetchPDFs() {
    ...
    fetch(`../php/fetch_pdfs.php?search=${search}&year=${year}`)
    ...
    data.forEach(pdf => {
            ...
            <a href="../php/view.php?file=${pdf.filename}" target="_blank" class="pdfViewer">View</a>
            <a href="../php/download.php?file=${pdf.filename}" class="pdfDownload">Download</a>
            `;
